package com.krzysztoffaj.customemailclient.controllers;
...
import com.krzysztoffaj.customemailclient.infrastructure.EmailResponseOptions;
import com.krzysztoffaj.customemailclient.services.EmailService;
import com.krzysztoffaj.customemailclient.services.UserService;
...
public class EmailComposerController {
    ...
    public void setupStage() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(EmailComposerController.class.getResource("/com/krzysztoffaj/customemailclient/views/EmailComposer.fxml"));
